// Measures HttpApiBuilder.Handlers.FromGroup for 1000 same-shaped endpoints in one group.
...
export type EndpointsByName = Handlers extends HttpApiBuilder.Handlers<any, infer Endpoints, any> ? Endpoints : never
export type HandlerNames = keyof EndpointsByName
